...
"""
Implementation of rational-quadratic splines in this file is from https://github.com/bayesiains/nsf
"""
...
def RQS(inputs, unnormalized_widths, unnormalized_heights,
    ...
    #derivatives = min_derivative + F.elu(unnormalized_derivatives) + 1. # shifted ELU faster
